...
const UpdatePreOrder = () => {
              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">Pre-order not found</p>
                  </div>
                </div>
              </div>
              ...
              <Card>
                <CardContent className="text-center py-8">
                  ...
                  <p className="text-muted-foreground mb-4">
                    The pre-order you're trying to edit does not exist.
                  </p>
  ...
  return (
    <div className="flex overflow-hidden">
                  ...
                  <CardContent>
                    {orderItems.length === 0 ? (
                      <div className="text-center py-8 text-muted-foreground">
                        ...
                        <p>No products in this pre-order</p>
                        <Button 
                          variant="outline" 
                          size="sm" 
                          className="mt-2"
        ...
        <DialogContent className="max-w-3xl max-h-[85vh] overflow-hidden flex flex-col">
          <DialogHeader>
            <DialogTitle className="flex items-center justify-between">
              <span>Add Product to Pre-Order</span>
              <Badge variant="outline" className="text-xs">
      ...
      <Button
        className="fixed bottom-6 right-6 h-14 w-14 rounded-full shadow-lg z-50 hover:scale-110 transition-transform bg-orange-600 hover:bg-orange-700"
        onClick={openProductModal}
      >
